...
AI 기반 브라우저 자동화(Claude MCP, Playwright MCP 등)는 매 실행마다 **AI 토큰을 소비**합니다.
로그인, VPN 신청, Jira 티켓 생성 같은 **반복 작업**에 매번 토큰을 쓰는 것은 비효율적입니다.

RecordFlow는 이 문제를 해결합니다:

| | AI 브라우저 자동화 | RecordFlow |
|---|---|---|
...
> **한 번 녹화하면 이후 실행에 토큰이 전혀 들지 않습니다.**
>
> AI는 워크플로우를 *만들 때* 쓰고, 반복 실행은 RecordFlow에 맡기세요.
